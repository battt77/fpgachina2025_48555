...
def main():
    ...
    m_model = model
    for i in m_model.transformer.layer:
        i.rel_attn.layer_norm=LN_RBN_BP_tch.LayerNormR(768,eps=1e-12,elementwise_affine=True,batch_size=batch_size)
        i.ff.layer_norm=LN_RBN_BP_tch.LayerNormR(768,eps=1e-12,elementwise_affine=True,batch_size=batch_size)
    m_model.end_logits.LayerNorm=LN_RBN_BP_tch.LayerNormR(768,eps=1e-12,elementwise_affine=True,batch_size=batch_size)
    print(m_model)
